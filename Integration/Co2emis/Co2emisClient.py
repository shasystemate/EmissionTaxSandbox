...
class Co2emisClient:
    ...
    def find_co2emis(self, price_area: str, datetime_utc_from: datetime,
                         datetime_utc_to: datetime) -> pd.Series:
        params = {'sql': self.create_co2emis_query(price_area, datetime_utc_from, datetime_utc_to)}
    ...
    def create_co2emis_query(self, price_area: str, datetime_utc_from: datetime,
